...
router.put("/shop/update", (req, res, next) => {
  Shop.findOneAndUpdate(req.params.id, req.body)
...
router.post("/offer/new", (req, res, next) => {
  Offer.create(req.params.id, req.body)
...
router.delete("/offer/delete", (req, res, next) => {
  ...
  .then(() => res.json({ delete: true, _id=req.params.id}));
})
...
/// create one
router.post("/offer/new", (req, res, next) => {
  Notification.create(req.params.id, req.body)
